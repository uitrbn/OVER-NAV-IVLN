...
def parse_args():
    ...
    parser.add_argument('--detection', action='store_true', default=False, help='use detection result')
    parser.add_argument('--close_voca_1', action='store_true', default=False, help='Close Voca Experiment - Type 1')
    parser.add_argument('--close_voca_2', action='store_true', default=False, help='Close Voca Experiment - Type 2')
    parser.add_argument('--neighbour_depth', type=int, default=0, help='detection depth')
    ...
    # model ablation:
    parser.add_argument('--ablation_depth', action='store_true', default=False)
    parser.add_argument('--ablation_angle', action='store_true', default=False)
