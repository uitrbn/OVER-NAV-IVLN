...
def get_vlnbert_models(args, config=None):
    ...
    from models.vilmodel_cmt import NavCMT_IVLN_OV

    model_class = NavCMT_IVLN_OV
    ...
    vis_config.ablation_depth = args.ablation_depth
    vis_config.ablation_angle = args.ablation_angle
    vis_config.shuffle = args.shuffle
